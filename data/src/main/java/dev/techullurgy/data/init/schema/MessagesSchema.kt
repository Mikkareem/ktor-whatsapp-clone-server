...
internal object MessagesTableStructure: TableStructure {
    ...
    const val MESSAGE_STATUS: String = "mesg_status"
    ...
    const val READ_TIME_BY_RECEIVER: String = "read_time_by_receiver"
    ...
    override val typeMap: Map<String, String>
        get() = HashMap<String, String>().apply {
            ...
            put(MESSAGE_STATUS, "enum('SENT', 'RECEIVED', 'READ') not null")
            put(SENDER_ID, "int")
            put(RECEIVER_ID, "int")
            put(SENT_TIME_FROM_SENDER, "datetime")
            put(RECEIVED_TIME_TO_RECEIVER, "datetime default null")
            put(READ_TIME_BY_RECEIVER, "datetime default null")
        }
